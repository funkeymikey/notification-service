...
namespace Notification.Core
{
    ...
    {
        /// <summary>
        /// This crap is necessary in order to display toast notifications, came out of the sample app
        /// </summary>
        /// <returns></returns>
        public static bool InitializeShortcut(String appName, String appID)
        {
        ...
        private static class ShellIIDGuid
        {
